package jdev.gab.lojavirtual.model;
...
public class CupDesc implements Serializable {
	...
	public Date getDataValidaCupom() {
		return dataValidaCupom;
	}

	public void setDataValidaCupom(Date dataValidaCupom) {
		this.dataValidaCupom = dataValidaCupom;
	}
